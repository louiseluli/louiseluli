...
- **MSc in Artificial Intelligence (2025):** _Fairness in Machine Learning for Adult Content Categorisation_
  - **Technical focus:** fairness evaluation and bias mitigation in metadata-based classification systems, using a dataset of 535k+ videos with emphasis on intersectional disparities.
